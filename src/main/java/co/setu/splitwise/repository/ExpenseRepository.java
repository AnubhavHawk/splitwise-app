...
public interface ExpenseRepository extends JpaRepository<Expense, String> {
    //SELECT * FROM expense e INNER JOIN expense_split_between es ON e.expense_id = es.expense_expense_id INNER JOIN split_between sb ON sb.split_id = es.split_between_split_id WHERE sb.to_be_paid_by_user_id = :userId
